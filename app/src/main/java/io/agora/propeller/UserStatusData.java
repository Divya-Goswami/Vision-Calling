...
public class UserStatusData {
    ...
    public UserStatusData(int uid, SurfaceView view, Integer status, int volume, io.agora.propeller.VideoInfoData i) {
        this.mUid = uid;
        this.mView = view;
        this.mStatus = status;
        this.mVolume = volume;
    ...
    private io.agora.propeller.VideoInfoData mVideoInfo;

    public void setVideoInfo(io.agora.propeller.VideoInfoData video) {
        mVideoInfo = video;
    }

    public io.agora.propeller.VideoInfoData getVideoInfoData() {
        return mVideoInfo;
    }
