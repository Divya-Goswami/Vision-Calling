package com.agora.cv.activities;
...
import com.agora.cv.stats.LocalStatsData;
import com.agora.cv.stats.RemoteStatsData;
import com.agora.cv.stats.StatsData;
import com.agora.cv.ui.VideoGridContainer;
...
public class LiveActivity extends RtcBaseActivity {
    ...
    private void initUI() {
        ...
        int role = getIntent().getIntExtra(
                com.agora.cv.Constants.KEY_CLIENT_ROLE,
    ...
    private void initData() {
        mVideoDimension = com.agora.cv.Constants.VIDEO_DIMENSIONS[
