...
//      mRtcEngine!!.setVideoProfile(Constants.VIDEO_PROFILE_360P, false) // Earlier than 2.3.0
    ...
    private fun joinChannel() {
        val sharedPreferences: SharedPreferences = this.getSharedPreferences("Agora",
        ...
        val channel_id = sharedPreferences.getString("channel_name", null)

        mRtcEngine!!.joinChannel(token, channel_id, "Extra Optional Data", 0) // if you do not specify the uid, we will generate the uid for you
    }
