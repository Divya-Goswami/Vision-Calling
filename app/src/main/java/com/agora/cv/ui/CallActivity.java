...
import com.agora.cv.model.DuringCallEventHandler;
import com.agora.cv.model.Message;
import com.agora.cv.model.User;
import com.agora.cv.ui.layout.GridVideoViewContainer;
import com.agora.cv.ui.layout.SmallVideoViewAdapter;
import com.agora.cv.ui.layout.SmallVideoViewDecoration;
...
import io.agora.propeller.RecyclerItemClickListener;
...
//           CALL_OPTIONS_REQUEST RecyclerView msgListView = (RecyclerView) findViewById(R.id.msg_list);
...
//        msgListView.addItemDecoration(new LinearLayoutManager());
    }
...
//                        String fps = getResources().getStringArray(R.array.string_array_frame_rate)[profileIndex];
                       ...
                       // String[] rwh = resolution.split("x");
                        ...
                        mGridVideoViewContainer.addVideoInfo(uid, new VideoInfoData(width > height ? width : height,
                                ...
                                0, Integer.valueOf(1), Integer.valueOf(0)));
                    }
                } else {
